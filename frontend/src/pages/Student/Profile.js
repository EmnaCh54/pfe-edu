...
export default function ProfileStudent() {
  ...
  const getProfile = async () => {
    try {
      ...
      const res1 = await StudentService.get(localStorage.getItem("userId"));
      setInscriptionNumber(res1.data.inscriptionNumber);
          ...
          <div className="card-body">
            <div>
              <Form onSubmit={updateProfile}>
                <h5>Numero d'inscription : {inscriptionNumber}</h5>
                <hr />
                <Form.Group>
